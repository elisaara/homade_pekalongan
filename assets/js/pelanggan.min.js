...
function add() {
    url = "add", $(".modal-title").html("Tambah Pelanggan"), $('.modal button[type="submit"]').html("Simpan")
}
...
function edit(a) {
    $.ajax({
        ...
        success: a => {
            $('[name="id"]').val(a.id), $('[name="nama"]').val(a.nama), $('[name="alamat"]').val(a.alamat), $('[name="telepon"]').val(a.telepon), $('[name="keterangan"]').val(a.keterangan), $(".modal").modal("show"), $(".modal-title").html("Edit Pelanggan"), $('.modal button[type="submit"]').html("Simpan"), url = "edit"
        },
        error: a => {
            console.log(a)
        }
