...
function add() {
    url = "add", $(".modal-title").html("Tambah Jenis Produk"), $('.modal button[type="submit"]').html("Simpan")
}
...
function edit(a) {
    $.ajax({
        ...
        success: a => {
            $('[name="id"]').val(a.id), $('[name="kategori"]').val(a.kategori), $(".modal").modal("show"), $(".modal-title").html("Edit Jenis Produk"), $('.modal button[type="submit"]').html("Simpan"), url = "edit"
        },
        error: a => {
            console.log(a)
        }
