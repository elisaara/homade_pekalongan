...
function add() {
    url = "add", $(".modal-title").html("Tambah Satuan Produk"), $('.modal button[type="submit"]').html("Simpan")
}
...
function edit(a) {
    $.ajax({
        ...
        success: a => {
            $('[name="id"]').val(a.id), $('[name="satuan"]').val(a.satuan), $(".modal").modal("show"), $(".modal-title").html("Edit Satuan Produk"), $('.modal button[type="submit"]').html("Simpan"), url = "edit"
        },
        error: a => {
            console.log(a)
        }
