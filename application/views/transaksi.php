      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <?php if ($role != 'admin'){ ?>
            <a href="<?php echo base_url('transaksi/pemasukan'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Pesanan</a>
            <?php } else { ?>
              &nbsp;
            <?php } ?>
          </div>
          <div class="card-body">
            <table class="table w-100 table-bordered table-hover" id="pemasukan">
              <thead>
                <tr>
