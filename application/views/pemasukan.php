        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <small class="form-text text-muted" style="display: none;" id="sisa"></small>
            </div>
            <div class="form-group">
              <label>Jumlah</label>
            ...
            <div class="form-group">
              <button id="tambah" class="btn btn-success" onclick="checkStok()" disabled><i class="fa fa-plus"></i> Tambah</button>
              <button id="simpan" class="btn btn-info" onclick="simpan()" disabled><i class="fa fa-save"></i> Simpan</button>
              <button id="bayar" class="btn btn-primary" data-toggle="modal" data-target="#modal" disabled><i class="fa fa-dollar-sign"></i> Bayar</button>
              <a href="<?php echo base_url('transaksi'); ?>" id="kembali" class="btn btn-danger"><i class="fa fa-list"></i> Daftar Pesanan</a>
            </div>
          </div>
          <div class="col-sm-6 d-flex justify-content-end text-right nota">
            <div>
              <div class="mb-0">
                <b class="mr-2">ID Pesanan/Nota</b> <span id="nota"></span>
              </div>
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        <input type="hidden" class="form-control" name="byr" id="byr" value=0>
        <label>Tanggal</label>
...
<script>
  ...
  var backUrl = '<?php echo site_url('transaksi') ?>';
  var generateUrl = '<?php echo site_url('transaksi/generate_pemasukan') ?>';
  var deleteUrl = '<?php echo site_url('transaksi/delete') ?>';
</script>
<script src="<?php echo base_url('assets/js/unminify/pemasukan.js') ?>"></script>
</body>
</html>
