      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <button class="btn btn-success" data-toggle="modal" data-target="#modal" onclick="add()"><i class="fa fa-plus"></i> Tambah Pengguna</button>
          </div>
          <div class="card-body">
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        <label>Tingkat</label>
        <select class="form-control" placeholder="Tingkat" name="level" id="level" required>
